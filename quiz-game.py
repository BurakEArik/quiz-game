...
words = {
    ...
    "non-verbal": "sözsüz",
    "consequence": "sonuç",
    "recruit (verb)": "askere almak",
    "recruit (noun)" : "acemi asker",
    ...
    "benefit (verb)": "yarar sağlamak",
    "benefit (isim)" : "menfaat",
...
def word_game():
    ...
    print("\nType 'quit' to exit the game or 'b' to reveal the answer.")
    global x
    global y
    global z
